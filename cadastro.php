...
if(!isset($_POST["nome"])|| !isset($_POST["cpf"])){
    $_POST["nome"] = "padrão";
    $_POST["cpf"] = "vazio";
    echo "<center>Preencha os campos em questão<center>";
}
...
fwrite($conteudo,"\n".$_POST["nome"]."\n".$_POST["cpf"]."\n==========================\n");
fclose($conteudo);     
echo "<center><h1>Usuário cadastrado, dê uma olhada no arquivo CADASTRO.TXT para mais informações<center></h1>";
